...
// //================================== თანამშრომლის ფილტში მოაქვს ფოტოც, გამოყენებულია ReactSelect ========================================================================================================================================
// import { useQuery } from "@tanstack/react-query";
// import { publicAxios } from "../config/axios";
// import TaskCard from "../components/TaskCard";
// import Loader from "../components/Loader";
...
//     setSelectedEmployees(selectedOption ? [String(selectedOption.value)] : []);
//   };
...
//     value: emp.id,
//     label: `${emp.name} ${emp.surname}`, // Ensure label is a string for placeholder
//     avatar: emp.avatar, // Store avatar separately
//   }));
...
//                   (emp) => emp.value === selectedEmployees[0]
//                 ) || null
//               }
//               onChange={handleEmployeeChange}
//               placeholder="თანამშრომელი"
//               className="max-w-50 w-full flex items-center py-3 px-5 rounded cursor-pointer"
//               components={{ SingleValue: customSingleValue }} // Apply custom rendering
//               getOptionLabel={(e) => (
//                 <div className="flex items-center">
//                   <img
//                     src={employees.find((emp) => emp.id === e.value)?.avatar}
//                     alt="avatar"
//                     className="w-6 h-6 rounded-full mr-2"
//                   />
//                   {employees.find((emp) => emp.id === e.value)?.name}{" "}
//                   {employees.find((emp) => emp.id === e.value)?.surname}
//                 </div>
//               )}
//             />
//           </div>
